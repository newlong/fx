          ...
          <tr>
            ...
            <td width="727" valign="top"><table width="715" border="0" align="right" cellpadding="0" cellspacing="0">
              ...
              <td valign="top" height="5">
                    <?=$cur_category_name?>品牌 <span style="padding-left:3px;">产品编号:</span> 
                                                <span style="color:red;"><?=$curtain_info->curtain_no?></span>
                </td>
              </tr>
              <tr>
                <td align="center">
                    <a href="<?=$curtain_info->file_url?>" target="_blank">
                    <img src="<?=$curtain_info->file_url?>" width="680" height="785" border="0">
                    </a>
                    <div style="text-align:center;padding-top:5px;">产品编号: <span style="font-weight:bold;"><?=$curtain_info->curtain_no?></span></div>
                </td>
              </tr>
              <tr>
                <td>&nbsp;</td>
